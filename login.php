...
<?php
if($INSTALL){
echo '<div style="width:100%;text-align:center;color:red;">Veuillez vous logguer en tant qu\'administrateur.</div>';
}
?>
...
<tr><td><?php echo username;?> :</td><td><input type="text" name="user" class="form"></td></tr>
